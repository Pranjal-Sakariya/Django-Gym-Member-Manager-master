# Django-Gym-Member-Manager-master
A real time Web application that provide all outlet for gym which uses this web app. It is more easy to enter member data and their details. Easy to operate. Run fast because of Django. 
